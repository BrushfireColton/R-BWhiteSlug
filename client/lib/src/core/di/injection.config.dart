...
import '../../services/profile_service.dart' as _i13;
import '../../services/profile_service_impl.dart' as _i14;
import '../../services/vendor_service.dart' as _i15;
import '../../services/vendor_service_impl.dart' as _i16;
import '../../ui/characters/character_selector_view_model.dart' as _i17;
import '../../ui/home_page/home_page_view_model.dart' as _i11;
import '../services/http_service_config.dart' as _i12;
import 'custom_injections_module.dart' as _i19;
...
_i1.GetIt $initGetIt(
  ...
  gh.factoryAsync<_i13.ProfileService>(() async => _i14.ProfileServiceImpl(
        await get.getAsync<_i12.HttpServiceConfig>(),
        get<_i3.Dio>(),
      ));
  gh.factoryAsync<_i15.VendorService>(() async => _i16.VendorServiceImpl(
        await get.getAsync<_i12.HttpServiceConfig>(),
        get<_i3.Dio>(),
      ));
  gh.factoryAsync<_i17.CharacterSelectorViewModel>(() async =>
      _i17.CharacterSelectorViewModel(
          await get.getAsync<_i13.ProfileService>()));
  return get;
}

class _$ThirdPartyModule extends _i18.ThirdPartyModule {}

class _$CustomInjectionsModule extends _i19.CustomInjectionsModule {}
